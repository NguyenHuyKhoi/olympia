      ...
      <Provider store={store}>
        <NavigationContainer>
          ...
          >
            ...
            />
            <stack.Screen
              name="practice_round1"
              component={PracticeRound1Screen}
            />
            <stack.Screen
              name="practice_round2"
              component={PracticeRound2Screen}
            />
            <stack.Screen
              name="practice_round3"
              component={PracticeRound3Screen}
            />
            <stack.Screen
              name="practice_round4"
              component={PracticeRound4Screen}
            />
            <stack.Screen
