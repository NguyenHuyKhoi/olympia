...
export const displayState = (state_code) => {
  switch (state_code) {
    ...
    case "reported":
      return "Đã bị báo cáo"
    case "freelancer_give_up":
      return "Bị hủy bởi freelancer"
    case "company_give_up":
      return " Bị hủy bởi công ty"
  }
}
...
export const validatePassword = (str) => {
  if (str.length < 6 || str.length > 30)
    return "Mật khẩu quá ngắn hoặc quá dài!"
  return null
}
